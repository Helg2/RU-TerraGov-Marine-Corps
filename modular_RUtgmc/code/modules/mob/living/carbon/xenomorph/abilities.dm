...
/datum/action/ability/activable/xeno/secrete_resin/update_button_icon()
	...
	if(SSmonitor.gamestate == SHUTTERS_CLOSED && CHECK_BITFIELD(SSticker.mode?.flags_round_type, MODE_ALLOW_XENO_QUICKBUILD) && SSresinshaping.active && is_ground_level(X.z))
