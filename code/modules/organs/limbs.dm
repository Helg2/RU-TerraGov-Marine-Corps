...
/datum/limb/proc/fracture()
	...
	//var/soundeffect = pick('sound/effects/bone_break1.ogg','sound/effects/bone_break2.ogg','sound/effects/bone_break3.ogg','sound/effects/bone_break4.ogg','sound/effects/bone_break5.ogg','sound/effects/bone_break6.ogg','sound/effects/bone_break7.ogg') // RUTGMC DELETION START
	//playsound(owner,soundeffect, 45, 1) // RUTGMC DELETION END
	playsound(owner, "bone_break", 45, 1) // RUTGMC ADDITION
	if(owner.species && !(owner.species.species_flags & NO_PAIN))
		owner.emote("scream")
